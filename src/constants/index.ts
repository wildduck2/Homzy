import { arrayOfObj, contactsItemsInfoType, valuesItemsInfoType } from "../vite-env"
...
export const valuesItemsInfo: valuesItemsInfoType = [
    {
        ...
        discription: 'Price we provides is the best for you, we guarantee no price changes on your property due to various unexpected costs that may come.'
    },
    {
        id: 1,
